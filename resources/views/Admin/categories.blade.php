            ...
            <div class="card-body">
                ...
                <table id="datatable2" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$category->name}}</td>
                                        <td>{{$category->loan_limit}}</td>
                                        <td>{{$category->contribution}}</td>
                                        <td>{{$category->timeline}}</td>
                                        <td>{{$currency->symbol ?? 'No Currency'}} </td>
                                        <td>{{$category->periodicals}}</td>
                                        <td>{{$category->status }}</td>
                                        <td>
                                            @if($category->status == "Active")
                                            <a href="/Admin/category_active_deactive/{{$category->id}}" class="btn btn-warning">Disable</a>
                                            @else
                                    ...
                                    <div class="modal-body">
                                          <form role="form" method="post" action="/Admin/Add-Category">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="number" name="person_limit" class="form-control" required placeholder="Enter Person Limit">
                                              </div>
                                              <div class="form-group">
                                                <label>Apply Loan Limit</label>
                                                <input type="number" name="loan_limit" class="form-control" required placeholder="Loan Limit Amount">
                                              </div>
                                              <div class="form-group">
                                                  <label>Contribution Amount</label>
                                                ...
                                                <div class="form-group">
                                                  <label>Timeline</label>
                                                    <input type="number" name="date" class="form-control" required placeholder="Number of Months">
                                                </div>
                                                <div class="form-group">
                                                    @php
                                                        $currencys = App\Models\Currency::get();
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <select name="periodicals" class="form-control" required>
                                                        @php
                                                            $periodicals=  ['Monthly', 'Quaterly', 'Yearly'];
                                                        @endphp
                                                        {{-- {{dd(config('periodicals'))}} --}}
