...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <a class="admin-logo dark-logo" href="index-2.html">
                        <h1>
        ...
        <div class="nano">
            <div class="nano-content sidebar-nav">
                ...
                <ul class="metisMenu nav flex-column" id="menu">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="index-2.html"><i class="fa fa-home"></i> <span class="toggle-none">Dashboard <span class="badge badge-pill badge-danger float-right mr-2">1.0</span></span></a></li>						
                    <li class="nav-item">
